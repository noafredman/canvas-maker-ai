...
function createNestedComponent() {
    ...
    const complexHTML = [
        '<div style="width: 100%; height: 100%; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: 3px solid #4c51bf; border-radius: 12px; padding: 20px; position: relative; color: white; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, sans-serif;">',
        ...
        '<div style="position: absolute; top: 60px; left: 20px; right: 20px; height: 280px; background: rgba(255,255,255,0.1); border: 2px solid rgba(255,255,255,0.3); border-radius: 8px; padding: 15px; cursor: move; backdrop-filter: blur(10px);">',
        '<h3 style="margin: 0 0 15px 0; color: #fff; font-size: 18px;">🏢 Level 2: Content Container</h3>',
        
        // Level 3: Sidebar
        '<div style="position: absolute; left: 15px; top: 40px; width: 140px; height: 220px; background: rgba(0,0,0,0.2); border: 2px solid rgba(255,255,255,0.2); border-radius: 6px; padding: 12px; cursor: move;">',
        ...
        '<div style="position: absolute; left: 170px; top: 40px; right: 15px; height: 220px; background: rgba(255,255,255,0.15); border: 2px solid rgba(255,255,255,0.25); border-radius: 6px; padding: 15px; cursor: move;">',
        '<h4 style="margin: 0 0 15px 0; font-size: 16px; font-weight: 600;">📈 Level 3: Stats Panel</h4>',
        
        // Level 4: Stats cards in a grid
        '<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 15px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.2); border-radius: 4px; padding: 8px;">',
        ...
        '<div style="display: flex; gap: 8px; justify-content: center; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.2); border-radius: 4px; padding: 8px;">',
        ...
        '<div style="position: absolute; bottom: 20px; left: 20px; right: 20px; background: rgba(0,0,0,0.3); border: 2px solid rgba(255,255,255,0.2); padding: 12px; border-radius: 6px; display: flex; justify-content: space-between; align-items: center; cursor: move;">',
        '<div style="font-size: 12px; font-weight: 500;">🔹 Level 2: Status Bar - System Online</div>',
        '<div style="display: flex; gap: 8px; align-items: center; background: rgba(0,0,0,0.1); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; padding: 4px;">',
