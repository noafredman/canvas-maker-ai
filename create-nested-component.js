...
function createNestedComponent() {
    ...
    const complexHTML = [
        ...
        '<div style="position: absolute; left: 170px; top: 40px; right: 15px; height: 220px; background: rgba(255,255,255,0.15); border-radius: 6px; padding: 15px; cursor: move;">',
        ...
        '<div style="background: rgba(34, 197, 94, 0.8); padding: 12px; border-radius: 6px; cursor: move; text-align: center; transition: transform 0.2s ease;" onmouseover="this.style.transform=\'scale(1.05)\'" onmouseout="this.style.transform=\'scale(1)\'">',
        '<div style="font-size: 24px; font-weight: bold; margin-bottom: 4px;">142</div>',
        '<div style="font-size: 11px; opacity: 0.9;">👥 Active Users</div>',
        '</div>',
        '<div style="background: rgba(59, 130, 246, 0.8); padding: 12px; border-radius: 6px; cursor: move; text-align: center; transition: transform 0.2s ease;" onmouseover="this.style.transform=\'scale(1.05)\'" onmouseout="this.style.transform=\'scale(1)\'">',
        '<div style="font-size: 24px; font-weight: bold; margin-bottom: 4px;">28</div>',
        '<div style="font-size: 11px; opacity: 0.9;">📦 New Orders</div>',
        '</div>',
        '<div style="background: rgba(245, 158, 11, 0.8); padding: 12px; border-radius: 6px; cursor: move; text-align: center; transition: transform 0.2s ease;" onmouseover="this.style.transform=\'scale(1.05)\'" onmouseout="this.style.transform=\'scale(1)\'">',
        '<div style="font-size: 24px; font-weight: bold; margin-bottom: 4px;">$4.2k</div>',
        '<div style="font-size: 11px; opacity: 0.9;">💰 Revenue</div>',
        '</div>',
        '<div style="background: rgba(239, 68, 68, 0.8); padding: 12px; border-radius: 6px; cursor: move; text-align: center; transition: transform 0.2s ease;" onmouseover="this.style.transform=\'scale(1.05)\'" onmouseout="this.style.transform=\'scale(1)\'">',
        ...
        '<button style="background: rgba(34, 197, 94, 0.8); border: none; padding: 8px 16px; border-radius: 4px; color: white; cursor: move; font-size: 12px; font-weight: 500; transition: all 0.2s ease;" onmouseover="this.style.background=\'rgba(34, 197, 94, 1)\'" onmouseout="this.style.background=\'rgba(34, 197, 94, 0.8)\'">🔄 Refresh</button>',
        '<button style="background: rgba(59, 130, 246, 0.8); border: none; padding: 8px 16px; border-radius: 4px; color: white; cursor: move; font-size: 12px; font-weight: 500; transition: all 0.2s ease;" onmouseover="this.style.background=\'rgba(59, 130, 246, 1)\'" onmouseout="this.style.background=\'rgba(59, 130, 246, 0.8)\'">📤 Export</button>',
        '<button style="background: rgba(107, 114, 128, 0.8); border: none; padding: 8px 16px; border-radius: 4px; color: white; cursor: move; font-size: 12px; font-weight: 500; transition: all 0.2s ease;" onmouseover="this.style.background=\'rgba(107, 114, 128, 1)\'" onmouseout="this.style.background=\'rgba(107, 114, 128, 0.8)\'">⚙️ Settings</button>',
        '</div>',
        '</div>',
        '</div>',
        ...
        '<div style="width: 10px; height: 10px; background: #f59e0b; border-radius: 50%; cursor: move; transition: transform 0.2s ease;" onmouseover="this.style.transform=\'scale(1.2)\'" onmouseout="this.style.transform=\'scale(1)\'" title="Warning"></div>',
        '<div style="width: 10px; height: 10px; background: #ef4444; border-radius: 50%; cursor: move; transition: transform 0.2s ease;" onmouseover="this.style.transform=\'scale(1.2)\'" onmouseout="this.style.transform=\'scale(1)\'" title="Error"></div>',
        '</div>',
        '</div>',
